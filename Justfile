...
install:
    ...
    if [[ "$ARCH" == "aarch64" || "$ARCH" == "arm64" ]]; then
        ...
        cat > deployment/docker-compose.override.arm64.yml << 'EOF'
# Platform-specific override for ARM64 architecture
# Generated by geosight-in-da-house for Raspberry Pi compatibility
version: '3.9'

services:
  db:
    platform: linux/arm64
    # Use the same image but explicitly specify platform
    # Docker will pull ARM64 variant or use emulation
EOF
