...
| `just run` | GeoSight の起動（本番モード） |
| `just load-demo-data` | デモデータ（サンプルプロジェクト、指標、地理データ）のロード |
...
- **サンプルプロジェクト**: 複数のダッシュボードとビジュアライゼーション
- **指標データ**: 人口、教育、健康などの統計データ
- **地理データ**: 国、地域、行政区画の境界データ
- **コンテキストレイヤー**: 背景地図や参照レイヤー
